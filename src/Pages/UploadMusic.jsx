              ...
              <div className="osahan-form">
                ...
                <div className="row">
                  <div className="col-lg-6">
                    <div className="form-group">
                      <label htmlFor="video-name">Music Name</label>
                      <input
                        type="text"
                        placeholder="title..."
                        className="form-control"
                  ...
                  <div className="col-lg-6">
                    <label htmlFor="upload-video">Music Thumbnail</label>
                  ...
                  <div className="col-lg-6">
                    <label htmlFor="upload-video">Upload Music</label>
                    <div className="custom-file">
                      ...
                      />
                       <label
                        ...
                        htmlFor="validatedCustomFile"
                      >
                        {musicFile ? musicFile.name : "Browse file..."} 
                      </label>
