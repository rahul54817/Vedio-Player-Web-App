...
const GetMyMusic = ({myChannelMusic}) => {
  ...
  const deletMusicById = (id) =>{
    const data = {
      _id : id,
      user_id : localStorage.getItem('_id')
    }
    axios.post('http://103.104.74.215:3003/api/delete_music',data)
    .then((response)=>{
  ...
  return (
    ...
    <div className="video-block section-padding" >
      <div className="row">
        ...
        {myChannelMusic?.map((object) => (
          <div className="col-xl-3 col-sm-6 mb-3">
            <div className="video-card " 
           >
              <div className="video-card-image " onClick={()=> playMusic(object._id)} style={{cursor: 'pointer'}}>
                <a className="play-icon" >
                  <i className="fas fa-play-circle" />
                </a>
                <a   >
                  {object.music[0].filename ? (
                    <img
                      className="img-fluid"
              ...
              <div className="d-flex justify-content-btween ">
                ...
                <div className="dropdown myDropdown text-color-black col">
                      ...
                      >
                        ...
                        <a
                          className="dropdown-item text-dark"
                          onClick={()=>deletMusicById(object._id)}
                          
                        >
                          <i className="fa-solid fa-delete" 
