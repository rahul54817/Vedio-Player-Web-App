...
export default function SProfileUpdate() {
  return (
    <>
          ...
          <div className="col-xl-4">
            ...
            <div className="card mb-4 mb-xl-0">
              ...
              <div className="card-body text-center">
                ...
                <img style={{width:"10rem"}} className="img-account-profile rounded-circle mb-2" src="http://bootdey.com/img/Content/avatar/avatar1.png" alt />
